                ...
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-white py-3">
                        <h4 class="m-0 font-weight-bold text-primary">
                            <i class="fa-solid fa-plus me-2"></i>Cadastrar Nova Turma
                        </h4>
                    </div>
                        ...
                        <form action="{{ route('turmas.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="nome" name="nome" class="form-control" placeholder="Ex: 2º Ano A" value="{{ old('nome') }}" required>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-end gap-2 mt-4">
                                <a href="{{ route('turmas.index') }}" class="btn btn-outline-secondary px-4">Voltar</a>
                                <button type="submit" class="btn btn-primary px-4 shadow-sm">Salvar Turma</button>
                            </div>
                        </form>
                    </div>
                </div>
